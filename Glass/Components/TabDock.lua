...
function TabDock:InitializeTab(chatFrame, smf, closeWindow)
...
function TabDock:UnloadTab(chatFrame)
  local tab = _G[chatFrame:GetName().."Tab"]
...
function TabDock:OnEnterContainer()
...
function TabDock:OnLeaveContainer()
...
function TabDock:OnUpdateFrame()
  GeneralDockManager:SetWidth(MC:GetFrame():GetWidth())
...
Core.Components.TabDock = TabDock
